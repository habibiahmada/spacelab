        ...
        <div class="w-full max-w-md bg-white dark:bg-gray-900 shadow-lg rounded-2xl p-8 border border-gray-200 dark:border-gray-800">
            <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="email" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-950 text-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-30 transition" type="email" name="email" :value="old('email', $request->email)" required autofocus />
                ...
                <div class="space-y-1">
                    ...
                    <x-text-input id="password_confirmation" class="w-full rounded-xl border-gray-300 dark:border-gray-700 dark:bg-gray-950 text-gray-900 dark:text-gray-100 focus:border-indigo-500 focus:ring focus:ring-indigo-400 focus:ring-opacity-30 transition" type="password" name="password_confirmation" required />
